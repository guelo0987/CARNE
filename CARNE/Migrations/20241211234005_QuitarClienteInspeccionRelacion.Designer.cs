...
namespace CARNE.Migrations
{
    ...
    [Migration("20241211234005_QuitarClienteInspeccionRelacion")]
    partial class QuitarClienteInspeccionRelacion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CARNE.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("CARNE.Models.Alerta", b =>
                {
            ...
            modelBuilder.Entity("CARNE.Models.Animale", b =>
                {
                    b.Property<int>("IdAnimal")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CARNE.Models.Documento", b =>
                {
            ...
            modelBuilder.Entity("CARNE.Models.Establecimiento", b =>
                {
            ...
            modelBuilder.Entity("CARNE.Models.Inspeccione", b =>
                {
            ...
            modelBuilder.Entity("CARNE.Models.ItemsVerificacion", b =>
                {
            ...
            modelBuilder.Entity("CARNE.Models.ListaVerificacion", b =>
                {
                    b.Property<int>("IdLista")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CARNE.Models.LotesProducto", b =>
                {
                    b.Property<int>("IdLote")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CARNE.Models.Normativa", b =>
                {
                    b.Property<int>("IdNormativa")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CARNE.Models.ResultadosInspeccion", b =>
                {
            ...
            modelBuilder.Entity("CARNE.Models.RolePermiso", b =>
                {
            ...
            modelBuilder.Entity("CARNE.Models.SancionIrregularidad", b =>
                {
                    b.Property<int>("IdIrregularidad")
                        .HasColumnType("int")
                        .HasColumnName("idIrregularidad");
            ...
            modelBuilder.Entity("CARNE.Models.Sancione", b =>
                {
                    b.Property<int>("IdSancion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CARNE.Models.Solicitud", b =>
                {
                    b.Property<int>("IdSolicitud")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AnimalesLote", b =>
                {
                    b.HasOne("CARNE.Models.Animale", null)
                        .WithMany()
                        .HasForeignKey("IdAnimal")
                        .IsRequired()
                        .HasConstraintName("FK__AnimalesL__idAni__208CD6FA");

                    b.HasOne("CARNE.Models.LotesProducto", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CARNE.Models.Alerta", b =>
                {
                    b.HasOne("CARNE.Models.Irregularidad", "IdIrregularidadNavigation")
                        .WithMany("Alerta")
            ...
            modelBuilder.Entity("CARNE.Models.Animale", b =>
                {
                    b.HasOne("CARNE.Models.Establecimiento", "IdEstablecimientoSacrificioNavigation")
                        .WithMany("Animales")
            ...
            modelBuilder.Entity("CARNE.Models.Documento", b =>
                {
                    b.HasOne("CARNE.Models.LotesProducto", "IdLoteNavigation")
                        .WithMany("Documentos")
                        .HasForeignKey("IdLote")
                        .IsRequired()
            ...
            modelBuilder.Entity("CARNE.Models.Irregularidad", b =>
                {
                    ...
                    b.HasOne("CARNE.Models.ResultadosInspeccion", "IdResultadoInspeccionNavigation")
                        .WithMany("Irregularidads")
            ...
            modelBuilder.Entity("CARNE.Models.ItemsVerificacion", b =>
                {
                    b.HasOne("CARNE.Models.ListaVerificacion", "IdListaNavigation")
            ...
            modelBuilder.Entity("CARNE.Models.ListaVerificacion", b =>
                {
                    b.HasOne("CARNE.Models.Normativa", "IdNormativaNavigation")
            ...
            modelBuilder.Entity("CARNE.Models.ResultadosInspeccion", b =>
                {
                    b.HasOne("CARNE.Models.Inspeccione", "IdInspeccionNavigation")
                        .WithMany("ResultadosInspeccions")
                        .HasForeignKey("IdInspeccion")
                        .IsRequired()
                        .HasConstraintName("FK__Resultado__idIns__32AB8735");

                    b.HasOne("CARNE.Models.ItemsVerificacion", "IdItemNavigation")
                        .WithMany("ResultadosInspeccions")
            ...
            modelBuilder.Entity("CARNE.Models.SancionIrregularidad", b =>
                {
                    ...
                    b.HasOne("CARNE.Models.Sancione", "IdSancionNavigation")
                        .WithMany("SancionIrregularidads")
            ...
            modelBuilder.Entity("CARNE.Models.Solicitud", b =>
                {
                    b.HasOne("CARNE.Models.Usuario", "IdUsuarioClienteNavigation")
                        .WithMany("Solicituds")
